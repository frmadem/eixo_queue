# This Makefile is for the Eixo::Queue extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Eixo/Queue.pm]
#     AUTHOR => [q[root <root@>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[Eixo::Queue]
#     PREREQ_PM => {  }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/Eixo/Queue.pm]
...
PARENT_NAME = Eixo
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Eixo/Queue.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
INST_LIBDIR      = $(INST_LIB)/Eixo
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Eixo
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name: Eixo-Queue' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Eixo-Queue",' >> META_new.json
